...
export const authenticateClientWithPrivateKey: AccountHandlers["AuthenticateClientWithPrivateKey"] =
  async (call, callback) => {
    try {
      const found = await client.client.authenticateWithPrivateKey(
