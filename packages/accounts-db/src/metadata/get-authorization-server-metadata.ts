export async function getAuthorizationServerMetadata() {
  ...
  return {
    ...
    endSessionEndpoint: `${host}/api/logout`,
    grantTypesSupported: [
      'authorization_code',
      'refresh_token',
      'client_credentials',
    ...
    introspectionEndpointAuthMethodsSupported: ['client_secret_basic', 'private_key_jwt', 'none'],
    ...
    revocationEndpointAuthMethodsSupported: ['client_secret_basic', 'private_key_jwt', 'none'],
