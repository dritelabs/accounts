  ...
  <div :class="['modal', { 'is-active': modal.isActive.value }]">
    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        ...
        <p class="mb-2">
          The private key appears only once for enhanced security. Copy this key
          and store it somewhere safe for use later.
        </p>
      ...
      <footer class="modal-card-foot is-justify-content-end">
        ...
        <button class="button is-link" @click="emit('save', props.publicKey)">
          Save
        </button>
      </footer>
    </div>
