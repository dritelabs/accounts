    ...
    <form>
      ...
      <div class="field is-horizontal">
        ...
        <div class="field-body">
          <div class="field">
            <div class="control">
              <input class="is-checkradio is-small is-link" id="authorization_code" type="checkbox"
                name="authorization_code" :checked="client.grantTypes.includes('authorization_code')"
                value="authorization_code" v-model="client.grantTypes" />
              <label for="authorization_code"> Authorization code </label>
              <input class="is-checkradio is-small is-link" id="client_credentials" type="checkbox"
                name="client_credentials" :checked="client.grantTypes.includes('client_credentials')"
                value="client_credentials" v-model="client.grantTypes" />
              <label for="client_credentials"> Client credentials </label>
              <input class="is-checkradio is-small is-link" id="refresh_token" type="checkbox" name="refresh_token"
                :checked="client.grantTypes.includes('refresh_token')" value="refresh_token"
      ...
      <div class="field is-horizontal">
        ...
        <div class="field-body">
          <div class="field">
            <div class="control">
              <input class="is-checkradio is-small is-link" id="rotate" type="radio"
                :checked="client.refreshTokenRotationType === 'rotate'" value="rotate"
                v-model="client.refreshTokenRotationType" />
              <label for="rotate"> Rotate token after every use </label>
              <input class="is-checkradio is-small is-link" id="static" type="radio"
                :checked="client.refreshTokenRotationType === 'static'" value="static"
                v-model="client.refreshTokenRotationType" />
      ...
      <div class="field is-horizontal">
        ...
        <div class="field-body">
          <div class="field">
            ...
            <p class="help">
              Location of your logo image. The image must be: In PNG, JPG, or
              GIF format Smaller than 1 MB in size
            </p>
          </div>
        </div>
      </div>
