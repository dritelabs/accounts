...
import { AddJWKToClientRequest } from "@driten/accounts-protobuf/dist/protobuf/jwk/AddJWKToClientRequest";
import { Client } from "@driten/accounts-protobuf/dist/protobuf/core/Client";
import { CreateClientRequest } from "@driten/accounts-protobuf/dist/protobuf/client/CreateClientRequest";
import { CreateJWKPairResponse } from "@driten/accounts-protobuf/dist/protobuf/jwk/CreateJWKPairResponse";
import { DeleteRequest } from "@driten/accounts-protobuf/dist/protobuf/core/DeleteRequest";
...
import { ListClientsResponse } from "@driten/accounts-protobuf/dist/protobuf/client/ListClientsResponse";
import { UpdateClientSecretRequest } from "@driten/accounts-protobuf/dist/protobuf/client/UpdateClientSecretRequest";
import { UpdateClientRequest } from "@driten/accounts-protobuf/dist/protobuf/client/UpdateClientRequest";
...
const addJwkToClient = promisify<
  AddJWKToClientRequest,
  grpc.Metadata | void,
  Client
>(client.addJwkToClient.bind(client));

const createJwkPair = promisify<
  Empty,
  grpc.Metadata | void,
  CreateJWKPairResponse
...
const deleteClient = promisify<DeleteRequest, grpc.Metadata | void, Client>(
  client.deleteClient.bind(client)
);

const getClient = promisify<GetRequest, grpc.Metadata | void, Client>(
  client.getClient.bind(client)
);

const listClients = promisify<
  ListRequest,
  grpc.Metadata | void,
  ListClientsResponse
>(client.listClients.bind(client));

const updateClientSecret = promisify<
  UpdateClientSecretRequest,
  grpc.Metadata | void,
  Client
>(client.updateClientSecret.bind(client));

const updateClient = promisify<
  UpdateClientRequest,
  grpc.Metadata | void,
  Client
