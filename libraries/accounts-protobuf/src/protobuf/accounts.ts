...
import type {
  AccountClient as _accounts_AccountClient,
  AccountDefinition as _accounts_AccountDefinition
...
export interface ProtoGrpcType {
  accounts: {
    Account: SubtypeConstructor<typeof grpc.Client, _accounts_AccountClient> & {
      service: _accounts_AccountDefinition;
    };
  };
  authorization_code: {
