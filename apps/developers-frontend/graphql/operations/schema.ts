...
export type GraphCacheResolvers = {
  Query?: {
    ...
    clients?: GraphCacheResolver<
      WithTypename<Query>,
      Record<string, never>,
      Array<WithTypename<Client> | string>
    >;
  ...
  Client?: {
    ...
    publicKeysConfiguration?: GraphCacheResolver<
      WithTypename<Client>,
      Record<string, never>,
      Scalars['String'] | string
    >;
    redirectUris?: GraphCacheResolver<
      WithTypename<Client>,
      Record<string, never>,
      Array<Scalars['String'] | string>
    >;
    refreshTokenRotationType?: GraphCacheResolver<
      WithTypename<Client>,
      Record<string, never>,
      Scalars['String'] | string
    >;
    responseTypes?: GraphCacheResolver<
      WithTypename<Client>,
      Record<string, never>,
      Array<Scalars['String'] | string>
    >;
    ...
    softwareVersion?: GraphCacheResolver<
      WithTypename<Client>,
      Record<string, never>,
      Scalars['String'] | string
    >;
    tokenEndpointAuthMethod?: GraphCacheResolver<
      WithTypename<Client>,
      Record<string, never>,
      Scalars['String'] | string
    >;
  ...
  JWKPair?: {
    privateKey?: GraphCacheResolver<
      WithTypename<JwkPair>,
      Record<string, never>,
      Scalars['JSONObject'] | string
    >;
    publicKey?: GraphCacheResolver<
      WithTypename<JwkPair>,
      Record<string, never>,
      Scalars['JSONObject'] | string
    >;
...
export type GraphCacheOptimisticUpdaters = {
  addJWKToClient?: GraphCacheOptimisticMutationResolver<
    MutationAddJwkToClientArgs,
    Maybe<WithTypename<Client>>
  >;
  ...
  updateClientSecret?: GraphCacheOptimisticMutationResolver<
    MutationUpdateClientSecretArgs,
    Maybe<WithTypename<Client>>
  >;
};
...
export type GraphCacheUpdaters = {
  Mutation?: {
    addJWKToClient?: GraphCacheUpdateResolver<
      { addJWKToClient: Maybe<WithTypename<Client>> },
      MutationAddJwkToClientArgs
    >;
    createClient?: GraphCacheUpdateResolver<
      { createClient: Maybe<WithTypename<Client>> },
      MutationCreateClientArgs
    >;
    createJWKPair?: GraphCacheUpdateResolver<
      { createJWKPair: Maybe<WithTypename<JwkPair>> },
      Record<string, never>
    >;
    deleteClient?: GraphCacheUpdateResolver<
      { deleteClient: Maybe<WithTypename<Client>> },
      MutationDeleteClientArgs
    >;
    updateClient?: GraphCacheUpdateResolver<
      { updateClient: Maybe<WithTypename<Client>> },
      MutationUpdateClientArgs
    >;
    updateClientSecret?: GraphCacheUpdateResolver<
      { updateClientSecret: Maybe<WithTypename<Client>> },
      MutationUpdateClientSecretArgs
    >;
  };
  Subscription?: {};
