...
<template>
  <article class="box is-shadowless">
    ...
    <div class="field is-horizontal" v-show="publicKeysConfiguration === 'jwks_uri'">
      <div class="field-label is-normal">
    ...
    <div
      ...
      v-show="publicKeysConfiguration === 'jwks' && client.tokenEndpointAuthMethod === 'private_key_jwt'"
    >
