  ...
  <article class="box is-shadowless">
    ...
    <div class="field is-horizontal">
      ...
      <div class="field-body">
        <div class="field">
          <div class="control">
            <input class="input" type="text" placeholder="Text input" disabled :value="client.id" />
          </div>
          <p class="help">Public identifier for the client that is required for all OAuth flows.</p>
        </div>
      </div>
    </div>
    ...
    <div class="field is-horizontal" v-show="client.tokenEndpointAuthMethod === 'client_secret_basic'">
    ...
    <div class="field is-horizontal" v-show="client.tokenEndpointAuthMethod === 'private_key_jwt'">
      <div class="field-label is-normal">
    ...
    <div
      ...
      v-show="
        client.tokenEndpointAuthMethod === 'private_key_jwt' && client.publicKeysConfiguration === 'remote'
      "
    >
      <div class="field-label is-normal">
      ...
      <div class="field-body">
        <div class="field">
          <div class="control">
            <input class="input" type="text" placeholder="Text input" v-model="client.jwksUri" />
          </div>
          <p class="help"></p>
        </div>
      </div>
    ...
    <div
      class="field is-horizontal"
      v-show="
        client.publicKeysConfiguration === 'local' && client.tokenEndpointAuthMethod === 'private_key_jwt'
      "
    >
              ...
              <table class="table is-fullwidth">
                ...
                <tbody>
                  <tr v-for="jwk in props?.client?.jwks?.keys">
                    ...
                    <td>
                      <ApplicationPublicKeyDetailsModal :jwk="currentPublicKey" />
                    </td>
                  </tr>
                </tbody>
              </table>
