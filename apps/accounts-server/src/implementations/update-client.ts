...
export const updateClient = withAuth<AccountHandlers['UpdateClient']>(['clients'], async (call, callback) => {
  try {
    const updated = await client.client.update({
      ...
      data: {
        ...
        publicKeysConfiguration:
          (call.request?.publicKeysConfiguration as prisma.PublicKeysConfiguration) || undefined,
        redirectUris: call.request?.redirectUris?.length ? call.request?.redirectUris : undefined,
        refreshTokenRotationType:
          (call.request?.refreshTokenRotationType as prisma.RefreshTokenRotationType) || undefined,
        ...
        tokenEndpointAuthMethod:
          (call.request?.tokenEndpointAuthMethod as prisma.TokenEndpointAuthMethod) || undefined,
