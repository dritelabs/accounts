...
export const config = {
  ...
  refreshTokenExpirationTime: process.env.REFRESH_TOKEN_EXPIRATION_TIME || 60 * 60 * 24 * 10,
  databaseUrl: process.env.DATABASE_URL || 'postgresql://driten:driten@localhost:5432/accounts',
